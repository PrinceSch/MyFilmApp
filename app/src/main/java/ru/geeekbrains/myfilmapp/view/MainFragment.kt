...
//1. Поиск по фильмам возвращает в том числе и «взрослый контент». Это параметр adult в ответе сервера.
// Создайте экран с настройками или чекбокс в меню приложения и добавьте туда настройку
// «включение — выключение» взрослого контента. Зафиксируйте эту настройку в SharedPreferences.
